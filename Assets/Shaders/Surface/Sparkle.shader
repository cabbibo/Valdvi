Shader "PostTransfer/Sparkle" {
  Properties {
    ...
    _TextureHueDifference("_TextureHueDifference", float ) = 1
    ...
    SubShader {
      ...
      uniform float _SparkleBright;
			uniform float _TextureHueDifference;
       ...
       samplerCUBE _CubeMap;
            ...
            float4 frag(varyings v) : COLOR {
				...
				col.xyz = hsv(hue + length(col.xyz) * _TextureHueDifference , 1, 1);
        ...
        col.xyz += tCol * hsv(rVal * _SparkleHue, 1,1) ;
            ...
            if( col.a < .1){discard;}
              return float4( col.xyz * shadow, col.a);
          }

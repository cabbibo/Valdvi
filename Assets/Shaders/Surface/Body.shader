...
Shader "Final/BodyPost"
{
  ...
  StructuredBuffer<Vert> _TransferBuffer;
        ...
        float hue = 1;
        col.xyz = hsv( match * _HueSize + _HueStart , 1, 1);
    ...
    /*
        ...
        Lighting Values for the shadow
...
sampler2D _MainTex;
  struct v2f {
    ...
    /*
       ...
       Lighting for the outline of the person
...
struct Vert{
    ...
    StructuredBuffer<Vert> _TransferBuffer;
			  ...
			  vertexOutput vert( uint id : SV_VertexID)
      {
				...
				output.color = float4(normal,1);//_OutlineColor;
				return output;
			}
